...
namespace proyecto_termotasajero.Controllers
{
    ...
    public class ParametrosOperacionCirculacionAguaController : Controller
    {
        ...
        {
            _logger.LogInformation("Entrando a Index de ParametrosOperacionCirculacionAguaController");
            ...
            try
            {
                ...
                _logger.LogInformation($"Se listaron {lista.Count} registros de ParametrosOperacionCirculacionAgua");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error al listar registros en Index de ParametrosOperacionCirculacionAguaController");
                return View("Error!");
            }
            return View(lista);
        }
        ...
        {
            _logger.LogInformation("Entrando a Registrar (GET) de ParametrosOperacionCirculacionAguaController");
        ...
        {
            _logger.LogInformation("Entrando a Registrar (POST) de ParametrosOperacionCirculacionAguaController");
            ...
            {
                _logger.LogError(ex, "Error al insertar registro en Registrar (POST) de ParametrosOperacionCirculacionAguaController");
                return View("Error!");
            }
        ...
        {
            _logger.LogError("Se ha accedido a la acción Error en ParametrosOperacionCirculacionAguaController");
            return View("Error!");
        }
    }
}
