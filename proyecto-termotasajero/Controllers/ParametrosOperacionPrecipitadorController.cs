...
namespace proyecto_termotasajero.Controllers
{
    ...
    public class ParametrosOperacionPrecipitadorController : Controller
    {
        ...
        {
            _logger.LogInformation("Entrando a Index de ParametrosOperacionPrecipitadorController");
            ...
            try
            {
                ...
                _logger.LogInformation($"Se listaron {lista.Count} registros de ParametrosOperacionPrecipitador");
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error al listar registros en Index de ParametrosOperacionPrecipitadorController");
                return View("Error!");
            }
            return View(lista);
        }
        ...
        {
            _logger.LogInformation("Entrando a Registrar (GET) de ParametrosOperacionPrecipitadorController");
        ...
        {
            _logger.LogInformation("Entrando a Registrar (POST) de ParametrosOperacionPrecipitadorController");
            if (!ModelState.IsValid)
            {
                _logger.LogWarning("ModelState inválido en Registrar (POST) de ParametrosOperacionPrecipitadorController");
            ...
            {
                _logger.LogError(ex, "Error al insertar registro en Registrar (POST) de ParametrosOperacionPrecipitadorController");
                return View("Error!");
            }
        ...
        {
            _logger.LogError("Se ha accedido a la acción Error en ParametrosOperacionPrecipitadorController");
            return View("Error!");
        }
    }
}